...
To initiate your project, create a new repository using [this](https://github.com/LASP-UCL/Publication-template) template. [Here](https://docs.github.com/en/repositories/creating-and-managing-repositories/creating-a-repository-from-a-template) is how to create a new repository from a template.
