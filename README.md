...
It provides: a) Skills we expect before you start, b) Tips on how to start your projects, c) Resources to deepen your knowledge in Deep and Reinforcement Learning, and d) Resources on how to improve your coding skills.
...
## 1. Skills we expect before you start
...
If you think you have to pay attention to one of the above, please consider taking the time to engage in the study of the above, before starting your project. The average learning time is around a full two weeks of study.
In our experience, starting your project without the elements above could make it a very hard challenge to complete it.


## 2. Organise your project
...
# Resources
Once you have setup an efficient way to communicate and track our work, here are some resources that can ease your journey to complete the project.
These are varied, and include study material, software, general tips, and hints on the computing infrastructure you might use.
...
#### Python Programming Introductory Tutorials
